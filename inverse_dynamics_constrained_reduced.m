function [tau_reduced, lambda] = inverse_dynamics_constrained_reduced(q_reduced, dq_reduced, ddq_reduced, model_reduced)
% 制約を考慮した制約付き逆動力学計算
...
% 元の制約付き逆動力学を使用
[tau_full, lambda] = inverse_dynamics_constrained(q_full, dq_full, ddq_full, model_original);

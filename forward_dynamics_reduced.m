function ddq_reduced = forward_dynamics_reduced(q_reduced, dq_reduced, tau_reduced, model_reduced)
% 制約を考慮した順動力学計算
% 制約: theta2 = -2*theta1 を考慮した削減された動力学
%
% 入力:
...
% 元の順動力学を使用して完全な加速度を計算
ddq_full = forward_dynamics(q_full, dq_full, tau_full, model_original);

% 制約を考慮した削減された加速度の抽出
% 制約: theta2 = -2*theta1 の二階微分: ddtheta2 = -2*ddtheta1
% したがって、削減された加速度はddtheta1のみ
